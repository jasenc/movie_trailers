# Import fresh_tomatoes.py in order to use the provided (and altered) website
# template.
...
drive = media.Movie('Drive',
                    'Ryan Gosling stars as a Los Angeles wheelman for hire, \
...
burn_after_reading = media.Movie('Burn After Reading',
                                 ...
                                 meeting.',
                                 'https://upload.wikimedia.org/wikipedia/en/a/ae/Burn_After_Reading.jpg',  # noqa
                                 'https://www.youtube.com/watch?v=eMWu6i7l5ec',
                                 'Coen Brothers',
                                 'Aug 27, 2008')

ex_machina = media.Movie('Ex Machina',
                         'A programmer at an internet-search giant, wins a \
...
kingsman = media.Movie('Kingsman',
                       'A super-secret spy organization that recruits an \
...
# Use fresh_tomatoes.py to render web page using automatically generated list
